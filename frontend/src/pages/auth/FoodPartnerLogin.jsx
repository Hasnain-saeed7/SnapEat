...
const FoodPartnerLogin = () => {
  ...
  const s = {
    ...
    wordSnap:   { color: '#E23744', fontWeight: 800, fontSize: 20, letterSpacing: '0.5px' },
    wordEat:    { color: '#059669', fontWeight: 800, fontSize: 20, letterSpacing: '0.5px' },
    wordRepeat: { color: '#F59E0B', fontWeight: 800, fontSize: 20, letterSpacing: '0.5px' },
    ...
    heading: {
      fontSize: 44, fontWeight: 900, color: '#1A1A1A',
      letterSpacing: '-1.5px', lineHeight: 1.1, margin: '0 0 10px',
    },
    headingAccent: { color: '#E23744' },
    subtext: { fontSize: 16, color: '#666', margin: '0 0 24px' },
    card: {
    ...
    btn: {
      ...
      // Green button to distinguish Partner login from User login (red)
  ...
  return (
    <div style={s.root}>
      ...
      {/* Main Content */}
      <div style={s.content}>
        <div style={s.badge}>🏪 Partner portal</div>

        <h1 style={s.heading}>
          Partner <span style={s.headingAccent}>login</span>
        </h1>
        <p style={s.subtext}>Access your dashboard and manage orders.</p>
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div style={s.fieldGroup}>
              ...
              <input
                ...
                autoComplete="email"
                onFocus={e => { e.target.style.border = '1px solid rgba(5,150,105,0.6)'; e.target.style.boxShadow = '0 0 0 3px rgba(5,150,105,0.12)'; }}
        ...
        <p style={s.footer}>
          New partner?{' '}
          <a href="/food-partner/register" style={s.link}>Create an account</a>
        </p>
      </div>
